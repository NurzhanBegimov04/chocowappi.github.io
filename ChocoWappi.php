...
<body>
    <header>
        <div class="container">
            ...
            <div class="ne-1">
                <div  id="izdey">
                    <form>
                        <input id="tags" type="text" name="izdey" class="search" placeholder="Іздеу...">
    ...
    <div class="slideF">
        <div id="slides">
          <div class="slide showing"><div class="darkcs"><h1>Аниме</h1></div></div>
          <div class="slide"><div class="darkcs"><h1>Фильмдер</h1></div></div>
          <div class="slide"><div class="darkcs"><h1>Ойындар</h1></div></div>
          <div class="slide"><div class="darkcs"><h1>Әзілдер</h1></div></div>
          <div class="buttons">
            <div class="prv_b" id="previous"></div>
            <div class="nxt_b" id="next"></div>
        </div>
      </div> 
    </div>   
        ...
        <div class="mainlist1">
            ...
            <div class="panel">
                <div class="list-group2">
                    ...
                    <a href="" class="list-group-item">Танымал</a>
                    ...
                    <a href="" class="list-group-item">Танымал адамдар</a>
                    <a href="" class="list-group-item">Жұмыс және хобби</a>
                    <a href="" class="list-group-item">Жануарлар</a>
                    <a href="" class="list-group-item">Музыка</a>
                    <a href="" class="list-group-item">Әзілдер</a>
                    <a href="" class="list-group-item">Бренды</a>
            ...
            <div class="list-group">
              ...
              <div class="card__top">
                <a href="" class="card__image">
                  <img src="./assets/img/e7576.png" alt="Max Gold" />
                </a>
                <div class="card__label">new</div>
              </div>
              <div class="card__bottom">
                <a href="#" class="card__title">Аленка с вашим лицом</a>
                <div class="prices__add">
                  <div class="price">500<small>₸</small></div>
